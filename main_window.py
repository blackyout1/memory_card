...
questions_list = [] 
questions_list.append(Question('Як перекладається назва нашої планети на англійску?', 'Earth', 'Zemlya', 'Ocean', 'Early'))
questions_list.append(Question('Яка столиця Франції?', 'Paris', 'London', 'Berlin', 'Madrid'))
questions_list.append(Question('Який континент найбільший за площею?', 'Asia', 'Africa', 'Europe', 'Antarctica'))
questions_list.append(Question('Який газ ми видихаємо?', 'Carbon dioxide', 'Oxygen', 'Nitrogen', 'Hydrogen'))
questions_list.append(Question('Скільки планет у Сонячній системі?', '8', '7', '9', '10'))
questions_list.append(Question('Що є джерелом світла для Землі?', 'Сонце', 'Місяць', 'Зірка Полярна', 'Марс'))
